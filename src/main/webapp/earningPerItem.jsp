...
<body style = "background-color: coral">
	...
	try {
		...
		String str = "SELECT p.product_id, p.brand, p.category, p.color, p.year, sum(a.current_bid) FROM product p, auction a WHERE p.product_id=a.product_id and a.status = 'close' and a.current_bid >= a.min_price group by p.brand, p.category, p.gender, p.color";
