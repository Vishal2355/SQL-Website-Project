...
<html>
<head>
<title>Check Create Auction Details</title>
<link rel="stylesheet"
...
<body>
	...
	PreparedStatement ps = null;
		...
		//try {
			...
			ps.setFloat(9, 0);
			int result = 0;
			result = ps.executeUpdate();//this line broke
		...
		if (result2.getString("alert_message").equals("Alert set for this item")
				&& !result2.getString("UserID").equals(seller)) {
			String str = "INSERT INTO alerts(UserID, alert_message, product_id, auction_id)"
					+ "VALUES(?, ?, ?, ?)";
	...
	<a href="createAuctions.jsp">Click here to try again.</a>
	<%
