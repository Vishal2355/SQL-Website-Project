...
<body style = "background-color: coral">
	<button onclick="window.location.href='accountInfo.jsp';">Return
		to account homepage</button>
	<h2>View My Bid History and all the auctions I have participated
		In</h2>
	<%
	...
	try {
		...
		String str = "select * from auction join bid using (auction_id) join product using (product_id) where buyer = '"
		+ UserID + "' order by amount ";
		;
