...
<body>
	<button onclick="window.location.href='searchProducts.jsp';">Return
		to Search Products Page</button>
	...
	try {
		...
		String str = "SELECT * FROM product WHERE category LIKE '%" + entity + "%' or brand LIKE '%" + entity
		+ "%' or color LIKE '%" + entity + "%' or gender LIKE '%" + entity + "%'";
		...
		out.print("<td>");
		out.print(
				"<form action='createAlertProduct.jsp' method='post'><button name='product_id' type='submit' value='"
